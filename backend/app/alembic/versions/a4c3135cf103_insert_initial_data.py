...
Revises: bf8857a3570d
Create Date: 2025-05-23 12:38:32.770133
...
def upgrade() -> None:
    ...
    op.execute("INSERT INTO academic_writing_schema.chapter (id, name) VALUES (1, 'Problem'), (2, 'Teorijske osnove'), (3, 'Rešenje'), (4, 'Rezultati')")
    op.execute("INSERT INTO academic_writing_schema.grading_aspect (id, name) VALUES "
    ...
    op.execute("INSERT INTO academic_writing_schema.chapter_grading_aspect(chapter_id, grading_aspect_id) VALUES "
    "(1, 1), (1, 2), (1, 13), (1, 14), (1, 15), (1, 16), " \
    "(2, 3), (2, 4), (2, 13), (2, 14), (2, 15), (2, 16), " \
    "(3, 5), (3, 6), (3, 7), (3, 8), (3, 9), (3, 13), (3, 14), (3, 15), (3, 16), " \
    "(4, 10), (4, 11), (4, 12), (4, 13), (4, 14), (4, 15), (4, 16)")
    op.execute("INSERT INTO academic_writing_schema.rule(name, description, include_in_prompt, grading_aspect_id) VALUES " \
    ...
    "('Značaj rešenja', 'Istaknuto je zašto je priloženo rešenje značajno za društvo. Objašnjava se koja je motivacija iza rešenja i problema koji se rešava.', true, 1), "
    ...
    "('Početak rečenice', 'Ne kretati rečenicu sa a, ili, i, kao ni sa brojevima.', true, 14), " \
    ...
    "('Zarezi', 'Obavezni kod a, ali, zabranjeni kod i, ili. Koristiti ih kod nabrajanja. Ako postoje dva nezavisna iskaza u jednoj rečenici, razdvojiti ih zarezom (iako bi ovo trebalo da budu dve odvojene rečenice u većini slučajeva). Obavezni kod apozicije (primer: Jovan, sin Miloša, voli voće.).', true, 14), " \
